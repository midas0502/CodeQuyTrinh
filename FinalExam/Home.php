...
<div style="display: inline-block; vertical-align: top; flex:1">
  <div class="thanhtren">
    <div>
      <a href="http://localhost/QuanLyTrangThietBi/VietAnh/FinalExam/Home.php" style="color: rgb(0, 172, 0); width:fit-content; display: inline-block; font-weight: bold; font-size:120%">QUẢN LÝ THIẾT BỊ</a>
      <a href="http://localhost/QuanLyTrangThietBi/VietAnh/qlkhophong/Home.php" style="color: rgb(200,200,200); width:fit-content; display: inline-block">QUẢN LÝ KHO PHÒNG</a>
    </div>
...
<div class="container-fluid col-md-6">
    ...
    <a href="InsertVB.php"><button type="button" class="btn btn-success">Thêm thiết bị</button></a>
    </div>
...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="UpdateVB.php?matb=<?php echo $row['matb']?>">Sửa</a>
          <a href="DeleteVB.php?matb=<?php echo $row['matb']?>">Xóa</a>
    </td>
    </tr>
